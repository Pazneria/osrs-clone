...
- [x] CRAFTING-003: Initial recipe families, economy values, dependencies, and item list consolidated.

## Now
- [ ] CRAFTING-004: Data model pass for crafting recipes (inputs, outputs, level, XP, action ticks, tool/station requirements).
- [ ] CRAFTING-005: Runtime action pipeline for immediate item-on-item assembly and 3-tick standard crafting actions.
- [ ] CRAFTING-006: Inventory validation and consumption flow for strapped handles, equipment assembly, gem cutting, and staff attachment.
