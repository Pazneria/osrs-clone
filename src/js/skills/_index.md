...
| Smithing | Planned | Recipe data model + runtime loop | Cross-skill assembly and jewelry-base integration | Core implementation not started |
| Crafting | Planned | Recipe data model + runtime pipeline | Jewelry/staff integration and mould unlock wiring | Core implementation not started |
