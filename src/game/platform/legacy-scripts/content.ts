...
import asset3dCatalogScript from "../../../js/content/asset-3d-catalog.js?raw";
import playerAppearanceCatalogScript from "../../../js/content/player-appearance-catalog.js?raw";
import npcAppearanceCatalogScript from "../../../js/content/npc-appearance-catalog.js?raw";
...
export const contentLegacyScriptsById: Readonly<Record<string, LegacyScriptEntry>> = {
  ...
  "asset-3d-catalog": { id: "asset-3d-catalog", filename: "src/js/content/asset-3d-catalog.js", code: asset3dCatalogScript },
  ...
  "npc-appearance-catalog": { id: "npc-appearance-catalog", filename: "src/js/content/npc-appearance-catalog.js", code: npcAppearanceCatalogScript },
